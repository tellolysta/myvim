...
if has("gui_running")
    ...
    hi WildMenu       gui=BOLD   guifg=#eeeeee   guibg=#eeeeee
    ...
    exec "hi StatusLine     cterm=BOLD   ctermfg=" . <SID>X(106) . " ctermbg=" . <SID>X(44)
    ...
    exec "hi VertSplit      cterm=NONE   ctermfg=" . <SID>X(44) . " ctermbg=" . <SID>X(44)
    ...
    exec "hi Comment        cterm=NONE   ctermfg=" . <SID>X(04) . " ctermbg=" . "NONE"
    exec "hi Constant       cterm=NONE   ctermfg=" . <SID>X(73) . " ctermbg=" . "NONE"
    exec "hi String         cterm=NONE   ctermfg=" . <SID>X(76) . " ctermbg=" . "NONE"
